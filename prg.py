...
root=Tk()
root.title("color picker form image")
...
def Findcolor():
    ...
    hex1.configure(text=color1)
    hex2.configure(text=color2)
    hex3.configure(text=color3)
    hex4.configure(text=color4)
    hex5.configure(text=color5)
    hex6.configure(text=color6)
    hex7.configure(text=color7)
    hex8.configure(text=color8)
    hex9.configure(text=color9)
    hex10.configure(text=color10)
...
logo=PhotoImage(file="logoround.png")
Label(frame,image=logo,bg="#fff").place(x=10,y=10)

Label(frame,text="Color Find",font="arial 25 bold",bg="white").place(x=100,y=20)
...
id2 = colors.create_rectangle((10,10,50,100),fill="#db4035")
...
id7 = colors2.create_rectangle((10,10,50,100),fill="#299438")
